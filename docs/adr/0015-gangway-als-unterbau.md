...
**Überarbeitet durch:** —
**Verwandt:** [ADR-0009](0009-resource-server-statt-eigener-authorization-server.md), [ADR-0010](0010-idp-agnostische-konfiguration.md), [ADR-0011](0011-capability-gating.md), [ADR-0016](0016-anbieter-namensraeume-statt-roher-oidc-parameter.md), [Gangway](https://github.com/strausmann/gangway)
